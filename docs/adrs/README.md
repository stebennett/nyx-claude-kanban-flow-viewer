...
| [ADR-0004](0004-ci-gates-single-reusable-workflow-no-build-state-caching.md) | CI gates run as a single reusable workflow, with no build-state caching | Accepted | CARD-002 | 2026-07-18 |
