...
## Test
- CARD-027 — SSE endpoint sends the current snapshot on connect · test · feature/027-sse-snapshot-on-connect [M2] · ADR-0014 · implement done (499 lines, 1 under cap)

## Review

## Deliver
- CARD-023 — CLI --board-dir flag · deliver · feature/023-cli-board-dir-flag [M2] · ADR-0012 · review pass (8 lenses, 0 blocking, 14 advisories) · opening PR
